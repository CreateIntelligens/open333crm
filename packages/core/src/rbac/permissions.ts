...
export const PERMISSIONS: readonly PermissionDef[] = [
  ...
  { code: 'agent.deactivate', group: '人員與權限', feature: 'core', label: '停用成員', description: '停用成員帳號（可再啟用，保留 email）', dependsOn: ['agent.view'] },
  { code: 'agent.purge', group: '人員與權限', feature: 'core', label: '刪除成員', description: '永久刪除成員帳號並釋放 email（不可復原）', dependsOn: ['agent.view'] },
  { code: 'agent.delete', group: '人員與權限', feature: 'core', label: '刪除成員（舊）', description: '（已淘汰，改用 agent.deactivate / agent.purge）', dependsOn: ['agent.view'] },
